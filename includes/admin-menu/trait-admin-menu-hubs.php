	...
	public function register_admin_pages(): void {
		...
		// Los widgets del Escritorio las enlazan como "Ver completo".
			...
			array( 'clms-settings',            $settings_cap,                 'render_settings_page' ),
				...
				array( 'atora-emails',             $settings_cap,                 'render_atora_emails_page' ),
				array( 'atora-newsletter',         $settings_cap,                 'render_atora_newsletter_page' ),
				array( 'atora-messaging',          $settings_cap,                 'render_atora_messaging_page' ),
				array( 'atora-automations',        $settings_cap,                 'render_atora_automations_page' ),
