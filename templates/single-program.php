<?php
/**
 * Single Program Template — Program Overview
 * ATORA-LMS
 *
 * Wrapper delgado para la vista académica del programa.
 * Resuelve schema `program_overview` y delega a Template Engine.
 */
...
if ( ( '' !== trim( $_cta_url ) && ! $_enrolled ) || ! is_user_logged_in() ) :
