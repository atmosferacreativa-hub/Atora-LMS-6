...
class CLMS_REST_Routes {
	...
	public function register() {
		$routes = array(
			...
			array(
				'route'  => '/gradebook/institutional',
				'routes' => array(
					array(
						'methods'             => WP_REST_Server::READABLE,
						'callback'            => array( $this->api, 'get_institutional_gradebook_context' ),
						'permission_callback' => array( $this->api, 'can_manage_institutional_gradebook' ),
					),
				),
			),
			array(
				'route'  => '/gradebook/institutional/periods',
				'routes' => array(
					array(
						'methods'             => WP_REST_Server::CREATABLE,
						'callback'            => array( $this->api, 'create_institutional_period' ),
						'permission_callback' => array( $this->api, 'can_manage_institutional_gradebook' ),
					),
				),
			),
			array(
				'route'  => '/gradebook/institutional/periods/(?P<id>\d+)/transition',
				'routes' => array(
					array(
						'methods'             => WP_REST_Server::CREATABLE,
						'callback'            => array( $this->api, 'transition_institutional_period' ),
						'permission_callback' => array( $this->api, 'can_manage_institutional_gradebook' ),
					),
				),
			),
			array(
				'route'  => '/gradebook/institutional/scales',
				'routes' => array(
					array(
						'methods'             => WP_REST_Server::CREATABLE,
						'callback'            => array( $this->api, 'create_institutional_scale' ),
						'permission_callback' => array( $this->api, 'can_manage_institutional_gradebook' ),
					),
				),
			),
			array(
				'route'  => '/gradebook/institutional/cycles',
				'routes' => array(
					array(
						'methods'             => WP_REST_Server::CREATABLE,
						'callback'            => array( $this->api, 'create_institutional_cycle' ),
						'permission_callback' => array( $this->api, 'can_manage_institutional_gradebook' ),
					),
				),
			),
			array(
				'route'  => '/gradebook/institutional/cycles/(?P<id>\d+)/grades',
				'routes' => array(
					array(
						'methods'             => WP_REST_Server::CREATABLE,
						'callback'            => array( $this->api, 'save_institutional_grade' ),
						'permission_callback' => array( $this->api, 'can_manage_institutional_gradebook' ),
					),
				),
			),
			array(
				'route'  => '/gradebook/institutional/cycles/(?P<id>\d+)/transition',
				'routes' => array(
					array(
						'methods'             => WP_REST_Server::CREATABLE,
						'callback'            => array( $this->api, 'transition_institutional_cycle' ),
						'permission_callback' => array( $this->api, 'can_manage_institutional_gradebook' ),
					),
				),
			),
			array(
				'route'  => '/gradebook/institutional/rectifications',
				'routes' => array(
					array(
						'methods'             => WP_REST_Server::CREATABLE,
						'callback'            => array( $this->api, 'request_grade_rectification' ),
						'permission_callback' => array( $this->api, 'can_manage_institutional_gradebook' ),
					),
				),
			),
			array(
				'route'  => '/gradebook/institutional/rectifications/(?P<id>\d+)/decision',
				'routes' => array(
					array(
						'methods'             => WP_REST_Server::CREATABLE,
						'callback'            => array( $this->api, 'decide_grade_rectification' ),
						'permission_callback' => array( $this->api, 'can_manage_institutional_gradebook' ),
					),
				),
			),
